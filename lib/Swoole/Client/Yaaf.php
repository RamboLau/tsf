...
class Yaaf extends Protocal
{
  ...
  private $jm;
   //json_manege对象,把json打包成二进制buffer
  private $headConf;
  ...
  private function packHead($uin, $cmd)
  {
    ...
    $headBuf = pack($this->headConf['packFormat'], $this->headConf['version'], $this->headConf['packetType'], $this->headConf['bodyFormat'], $this->headConf['seqNo'], $this->headConf['uin'], $this->headConf['groupId'], $this->headConf['appId'], $this->headConf['appName'], $this->headConf['cmd'], $this->headConf['defaultErrCode'], $this->headConf['clientIp'], $this->headConf['serverIp'], $this->headConf['flags'], $this->headConf['reserved']);
    return $headBuf;
  }
